...
local function JTIAV_fake_script() -- Progress.ProgressScript 
	...
	local script = Instance.new('LocalScript', pcnt)
	...
	local objs = {
		...
		["TransOfPercentPart"] = {"NumberValue",0.5},
	}
	...
	task.wait(.5)
	Frame:TweenPosition(UDim2.new(-.5,0,Frame.Position.Y.Scale,0,Enum.EasingDirection.Out,Enum.EasingStyle.Linear,2.5))
	task.wait(2.5)
